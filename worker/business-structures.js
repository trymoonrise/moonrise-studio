...
const SECTION_PRESET_CATEGORIES = {
  ...
  credibility: ["hooks", "features", "announcement", "badges"],
  services: ["features", "cards", "sections", "pricing"],
  about: ["sections", "bios", "text"],
  gallery: ["galleries", "images", "cards"],
  testimonials: ["testimonials", "hooks", "cards"],
  pricing: ["pricing", "cards", "features"],
  team: ["bios", "profiles", "avatars", "cards"],
  faq: ["accordions", "sections"],
  hours_location: ["sections", "text"],
  map: ["maps"],
  cta_band: ["cta", "buttons", "announcement"],
