...
const { RECIPES, extractBgDesc } = require('./recipes/backgrounds');
...
function main() {
  ...
  for (const entry of manifest) {
    if (entry.category !== 'backgrounds') continue;
    const desc = extractBgDesc(entry.slug);
  ...
  console.log(`Rewrote ${count} background presets`);
}
