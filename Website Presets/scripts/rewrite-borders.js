...
const { RECIPES, extractBorderDesc } = require('./recipes/borders');
...
function main() {
  ...
  for (const entry of manifest) {
    if (entry.category !== 'borders') continue;
    const desc = extractBorderDesc(entry.slug);
  ...
  console.log(`Rewrote ${count} border presets`);
}
